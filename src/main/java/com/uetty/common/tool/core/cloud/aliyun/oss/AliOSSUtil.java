package com.uetty.common.tool.core.cloud.aliyun.oss;
...
public class AliOSSUtil {
    ...
    public static OSSClient obtainClientBySts(String accessKey, String secret, String stsToken, String endpoint) {
        CredentialsProvider credentialProvider = new DefaultCredentialProvider(accessKey, secret, stsToken);
        ClientConfiguration clientConfiguration = new ClientConfiguration();
        clientConfiguration.setProtocol(Protocol.HTTPS);
